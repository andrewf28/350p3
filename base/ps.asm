...
000002db <getpid>:
SYSCALL(getpid)
 2db:	b8 0b 00 00 00       	mov    $0xb,%eax
 2e0:	cd 40                	int    $0x40
 2e2:	c3                   	ret

000002e3 <sbrk>:
SYSCALL(sbrk)
 2e3:	b8 0c 00 00 00       	mov    $0xc,%eax
 2e8:	cd 40                	int    $0x40
 2ea:	c3                   	ret

000002eb <sleep>:
SYSCALL(sleep)
 2eb:	b8 0d 00 00 00       	mov    $0xd,%eax
 2f0:	cd 40                	int    $0x40
 2f2:	c3                   	ret

000002f3 <uptime>:
SYSCALL(uptime)
 2f3:	b8 0e 00 00 00       	mov    $0xe,%eax
 2f8:	cd 40                	int    $0x40
 2fa:	c3                   	ret

000002fb <shutdown>:
SYSCALL(shutdown)
 2fb:	b8 16 00 00 00       	mov    $0x16,%eax
 300:	cd 40                	int    $0x40
 302:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 656:	56                   	push   %esi
 657:	e8 87 fc ff ff       	call   2e3 <sbrk>
  if(p == (char*)-1)
