...
00000300 <openiputtest>:
{
  ...
  sleep(1);
     ...
     373:	6a 01                	push   $0x1
     375:	e8 d1 35 00 00       	call   394b <sleep>
  if(unlink("oidir") != 0){
...
00000da0 <mem>:
{
  ...
  ppid = getpid();
     db6:	e8 80 2b 00 00       	call   393b <getpid>
    ...
    2d35:	31 f6                	xor    %esi,%esi
{
  ...
  oldbrk = sbrk(0);
    ...
    2d52:	e8 ec 0b 00 00       	call   3943 <sbrk>
    2d57:	89 45 a4             	mov    %eax,-0x5c(%ebp)
  a = sbrk(0);
    2d5a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2d61:	e8 dd 0b 00 00       	call   3943 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d75:	6a 01                	push   $0x1
    2d77:	e8 c7 0b 00 00       	call   3943 <sbrk>
    if(b != a){
  ...
  c = sbrk(1);
    2dad:	6a 01                	push   $0x1
    2daf:	e8 8f 0b 00 00       	call   3943 <sbrk>
  c = sbrk(1);
    2db4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbb:	e8 83 0b 00 00       	call   3943 <sbrk>
  if(c != a + 1){
  ...
  a = sbrk(0);
    ...
    2ddb:	6a 00                	push   $0x0
    2ddd:	e8 61 0b 00 00       	call   3943 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dee:	e8 50 0b 00 00       	call   3943 <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e08:	6a 00                	push   $0x0
    2e0a:	e8 34 0b 00 00       	call   3943 <sbrk>
  c = sbrk(-4096);
    2e0f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e16:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e18:	e8 26 0b 00 00       	call   3943 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e2c:	6a 00                	push   $0x0
    2e2e:	e8 10 0b 00 00       	call   3943 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e47:	6a 00                	push   $0x0
    2e49:	e8 f5 0a 00 00       	call   3943 <sbrk>
  c = sbrk(4096);
    2e4e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e55:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e57:	e8 e7 0a 00 00       	call   3943 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e6c:	6a 00                	push   $0x0
    2e6e:	e8 d0 0a 00 00       	call   3943 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2ecf:	90                   	nop
    ppid = getpid();
    2ed0:	e8 66 0a 00 00       	call   393b <getpid>
  ...
  c = sbrk(4096);
    ...
    2f57:	e8 e7 09 00 00       	call   3943 <sbrk>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f93:	6a 00                	push   $0x0
    2f95:	e8 a9 09 00 00       	call   3943 <sbrk>
    ...
    3184:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31ae:	6a 00                	push   $0x0
    31b0:	e8 96 07 00 00       	call   394b <sleep>
    sleep(0);
    31b5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31bc:	e8 8a 07 00 00       	call   394b <sleep>
    kill(pid);
...
000035e0 <argptest>:
{
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    35ff:	6a 00                	push   $0x0
    3601:	e8 3d 03 00 00       	call   3943 <sbrk>
...
00003933 <dup2>:
SYSCALL(dup2)
    3933:	b8 19 00 00 00       	mov    $0x19,%eax
    3938:	cd 40                	int    $0x40
    393a:	c3                   	ret

0000393b <getpid>:
SYSCALL(getpid)
    393b:	b8 0b 00 00 00       	mov    $0xb,%eax
    3940:	cd 40                	int    $0x40
    3942:	c3                   	ret

00003943 <sbrk>:
SYSCALL(sbrk)
    3943:	b8 0c 00 00 00       	mov    $0xc,%eax
    3948:	cd 40                	int    $0x40
    394a:	c3                   	ret

0000394b <sleep>:
SYSCALL(sleep)
    394b:	b8 0d 00 00 00       	mov    $0xd,%eax
    3950:	cd 40                	int    $0x40
    3952:	c3                   	ret

00003953 <uptime>:
SYSCALL(uptime)
    3953:	b8 0e 00 00 00       	mov    $0xe,%eax
    3958:	cd 40                	int    $0x40
    395a:	c3                   	ret

0000395b <shutdown>:
SYSCALL(shutdown)
    395b:	b8 16 00 00 00       	mov    $0x16,%eax
    3960:	cd 40                	int    $0x40
    3962:	c3                   	ret
...
0000396b <chpr>:
SYSCALL(chpr)
    396b:	b8 18 00 00 00       	mov    $0x18,%eax
    3970:	cd 40                	int    $0x40
    3972:	c3                   	ret
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3cb6:	56                   	push   %esi
    3cb7:	e8 87 fc ff ff       	call   3943 <sbrk>
  if(p == (char*)-1)
